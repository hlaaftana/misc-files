...
import hlaaftana.karmafields.lang.interpreter.ArgumentException;
import hlaaftana.karmafields.lang.interpreter.NumberValue;
...
public interface Value {
	...
	default boolean checkSetProperty(String name, Value value, String check, Class... types) throws ArgumentException {
		if (name.equals(check)) {
			for (Class t : types)
				if (t.isInstance(value)) return true;
